...
public class ChangeNameDialog extends JDialog {
    ...
    private JFormattedTextField newNameField;
    ...
    private void onOK() {
        ...
        profileControl.ChangeName(newNameField.getText());
        if (profileControl.Check()) {
            ErrorMessageForm error = new ErrorMessageForm("Такое имя пользователя уже существует");
            error.pack();
            profileControl.Close();
            return;
        }
        SuccessMessageForm success = new SuccessMessageForm("Имя пользователя изменено");
        success.pack();
        profileControl.Close();
        dispose();
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Введите новое имя пользователя:");
