...
public class DeleteProfile extends JDialog {
    ...
    private void onOK() {
        ...
        profileControl.DeleteUser(passwordField1.getPassword());
        if (profileControl.Check()) {
            ErrorMessageForm error = new ErrorMessageForm("Пароль введен неверно");
            error.pack();
            profileControl.Close();
            return;
        }
        SuccessMessageForm success = new SuccessMessageForm("Профиль удален");
        success.pack();
        profileControl.Close();
        dispose();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Вы уверены, что хотите удалить профиль?");
